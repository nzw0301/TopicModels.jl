struct PolylingualCGSLDA
    ...
    nkv_array::Array{Array{Int, 2}}
    ndk_array::Array{Array{Int, 2}}
    nk_array::Array{Array{Int, 1}}
    z_array::Array{Array{Array{Int, 1}, 1}}

    function PolylingualCGSLDA(corpora::Array{Corpus, 1}, k=10,
                               beta_array:Array{Float64, 1})
        @assert k > 0
        ...
        return new(corpora, k, corpus.V, corpus.D, beta,
